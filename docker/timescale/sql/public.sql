...
AS SELECT n.id AS net_id,
    ...
    n.additional_info->>'restrictedStatus'::text AS net_restrictedstatus,
    s.id AS station_id,
    ...
    s.additional_info AS station_additional_info,
    s.additional_info->>'restrictedStatus'::text AS station_restrictedstatus,
    s.n_channels AS totalnumberchannels,
    c.id AS channel_id,
    c.name AS channel_name,
    c.additional_info AS channel_additional_info,
    c.additional_info->>'restrictedStatus'::text as channel_restrictedstatus,
    ...
    CONCAT(dt.name, '-', dt.model,'-',dt.dynamical_range,'-VPP-',dt.final_sample_rate,dt.final_sample_rate_measure_unit) AS datalogger_final_name,
    COALESCE((c.additional_info ->> 'SampleRate'::text)::double precision, dt.final_sample_rate::double precision) AS final_sample_rate,
