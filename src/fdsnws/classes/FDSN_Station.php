...
Class FDSN_Station extends QueryManager {
	...
	public function getList($input) {
		...
		$query = "select 
			...
			to_char(fdsn_station.net_startdate, 'YYYY-MM-DD\"T\"HH24:MI:SS\"Z\"') as net_startdate,
			...
			to_char(fdsn_station.station_startdate, 'YYYY-MM-DD\"T\"HH24:MI:SS\"Z\"') as station_startdate,
			to_char(fdsn_station.station_enddate, 'YYYY-MM-DD\"T\"HH24:MI:SS\"Z\"') as station_enddate,
			...
			to_char(fdsn_station.channel_startdate, 'YYYY-MM-DD\"T\"HH24:MI:SS\"Z\"') as channel_startdate,
			to_char(fdsn_station.channel_enddate, 'YYYY-MM-DD\"T\"HH24:MI:SS\"Z\"') as channel_enddate,
