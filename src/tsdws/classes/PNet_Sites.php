...
Class Sites extends PNetManager {
	...
	public function getList($input) {
		...
		$query = "SELECT id, name, ST_AsGeoJSON(coords) AS coords, ST_AsGeoJSON(ST_Centroid(coords)) AS centroid, quote, additional_info FROM " . $this->tablename . " WHERE remove_time IS NULL ";
